...
import fr.cda.r20.f1.IntegrationTest;
import fr.cda.r20.f1.config.Constants;
import fr.cda.r20.f1.domain.PersistentToken;
import fr.cda.r20.f1.domain.User;
import fr.cda.r20.f1.repository.AuthorityRepository;
import fr.cda.r20.f1.repository.PersistentTokenRepository;
...
import fr.cda.r20.f1.service.dto.PasswordChangeDTO;
import fr.cda.r20.f1.web.rest.vm.KeyAndPasswordVM;
import fr.cda.r20.f1.web.rest.vm.ManagedUserVM;
