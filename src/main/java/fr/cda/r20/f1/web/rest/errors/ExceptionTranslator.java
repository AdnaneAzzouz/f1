package fr.cda.r20.f1.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof fr.cda.r20.f1.service.EmailAlreadyUsedException ||
            ex instanceof fr.cda.r20.f1.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof fr.cda.r20.f1.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "fr.cda.r20.f1");
    }
}
